...
*/  
	...
	Kirki::add_field( 'gi_theme_config', [
		...
		'section'     => 'background_image',
		'default'         => '<div class="customizer-divider">' . __( 'Body Background', 'essencetheme' ) . '</div>',
		'priority'    => 5,
	] );
	...
	Kirki::add_field( 'gi_theme_config', [
		...
		'label'       => esc_html__( 'Body Background', 'essencetheme' ),
		'description' => esc_html__( 'An image selected here will become the main background image for the entire page.   NOTE: This will only show when there is no background color for the body, or the color is set to some level of transparency (see "Body Background Color" below)', 'essencetheme' ),
		'section'     => 'background_image',
		'default'     => [
			'background-image'      => '',
...
*/  
	...
	Kirki::add_field( 'gi_theme_config', [
		...
		'section'     => 'background_image',
		'default'         => '<div class="customizer-divider">' . __( 'Content Background', 'essencetheme' ) . '</div>',
		'priority'    => 30,
	] );
	...
	Kirki::add_field( 'gi_theme_config', [
		...
		'label'       => esc_html__( 'Content Background', 'essencetheme' ),
		'description' => esc_html__( 'An image selected here will become the content area background image.   NOTE: This will only show when there is no background color set for the content area, or the color is set to some level of transparency (see "Content Area Background Color" below).', 'essencetheme' ),
		'section'     => 'background_image',
		'default'     => [
			'background'      => '',
			'background-repeat'     => 'repeat',
