...
// print '<pre>';
// print_r (Kirki_Helper::get_material_design_colors( 'all' ));
// print '</pre>';

// foreach(Kirki_Helper::get_material_design_colors( 'all' ) as $color_sets){
// 	echo "'".$color_sets . "',";
...
// }
        ...
        Kirki::add_field( 'gi_theme_config', array(
        	...
        	'label'       => __( 'Color One', 'gi-essence-theme' ),
        	'description' => esc_attr__( 'Select the prominent ACCENT color in your color palette', 'gi-essence-theme' ),
        	'section'     => 'colors',
        ...
        Kirki::add_field( 'gi_theme_config', array(
        	...
        	'label'       => __( 'Color Two', 'gi-essence-theme' ),
        	'description' => esc_attr__( 'Select the prominent DARK color in your color palette.', 'gi-essence-theme' ),
        	'section'     => 'colors',
        ...
        Kirki::add_field( 'gi_theme_config', array(
        	...
        	'label'       => __( 'Color Three', 'gi-essence-theme' ),
        	'description' => esc_attr__( 'Select the prominent LIGHT in your color palette.', 'gi-essence-theme' ),
        	'section'     => 'colors',
        ...
        Kirki::add_field( 'gi_theme_config', array(
        	...
        	'label'       => __( 'Color Four', 'gi-essence-theme' ),
        	'description' => esc_attr__( 'Select the alternative DARK color in your color palette.', 'gi-essence-theme' ),
        	'section'     => 'colors',
        ...
        Kirki::add_field( 'gi_theme_config', array(
        	...
        	'label'       => __( 'Color Fifth', 'gi-essence-theme' ),
        	'description' => esc_attr__( 'Select the alternative LIGHT color in your color palette.', 'gi-essence-theme' ),
        	'section'     => 'colors',
        ...
        Kirki::add_field( 'gi_theme_config', array(
        	...
        	'description' => esc_attr__( 'This swatch is reserved for pure white or a near-white gray that compliments the current palette. This will be the default post background color in posts and can be used anytime a high-contrast light color is needed.', 'gi-essence-theme' ),
        	'section'     => 'colors',
        ...
        Kirki::add_field( 'gi_theme_config', array(
        	...
        	'description' => esc_attr__( 'This will restore the original theme default colors. NOTE: THIS WILL NOT SAVE OTHER CHANGES. If you have other changes that have not yet been saved, please click the Publish button first.', 'gi-essence-theme' ),
        	'section'     => 'colors',
        	'default'     => 'off',
        	'priority'    => 10,
