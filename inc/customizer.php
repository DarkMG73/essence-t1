 ...
 */
function gi_essence_theme_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => 'gi_essence_theme_customize_partial_blogname',
			)
		);
		$wp_customize->selective_refresh->add_partial(
			'blogdescription',
			array(
				...
				'render_callback' => 'gi_essence_theme_customize_partial_blogdescription',
			)
		);
	}
}
add_action( 'customize_register', 'gi_essence_theme_customize_register' );
 ...
 * @return void
 */
function gi_essence_theme_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function gi_essence_theme_customize_partial_blogdescription() {
 ...
 */
function gi_essence_theme_customize_preview_js() {
...
add_action( 'customize_preview_init', 'gi_essence_theme_customize_preview_js' );

/**
 * Customizer admin styles and scripts
 */
function gi_enqueue_customizer_stylesheet() {
...
add_action( 'customize_controls_print_styles', 'gi_enqueue_customizer_stylesheet', 10, 2 ); 

function gi_enqueue_customizer_admin_scripts() {
