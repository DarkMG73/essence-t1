...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'essence-t1' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'essence-t1' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'essence-t1' ),
			'200'       => esc_html__( 'Light 200', 'essence-t1' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'essence-t1' ),
			'300'       => esc_html__( 'Book 300', 'essence-t1' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'essence-t1' ),
			'400'       => esc_html__( 'Normal 400', 'essence-t1' ),
			'regular'   => esc_html__( 'Normal 400', 'essence-t1' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'essence-t1' ),
			'500'       => esc_html__( 'Medium 500', 'essence-t1' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'essence-t1' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'essence-t1' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'essence-t1' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'essence-t1' ),
			'700'       => esc_html__( 'Bold 700', 'essence-t1' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'essence-t1' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'essence-t1' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'essence-t1' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'essence-t1' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'essence-t1' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'essence-t1' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'essence-t1' ),
		);
	}
