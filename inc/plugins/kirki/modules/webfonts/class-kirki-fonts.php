...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'gi-essence-theme' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'gi-essence-theme' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'gi-essence-theme' ),
			'200'       => esc_html__( 'Light 200', 'gi-essence-theme' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'gi-essence-theme' ),
			'300'       => esc_html__( 'Book 300', 'gi-essence-theme' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'gi-essence-theme' ),
			'400'       => esc_html__( 'Normal 400', 'gi-essence-theme' ),
			'regular'   => esc_html__( 'Normal 400', 'gi-essence-theme' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'gi-essence-theme' ),
			'500'       => esc_html__( 'Medium 500', 'gi-essence-theme' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'gi-essence-theme' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'gi-essence-theme' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'gi-essence-theme' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'gi-essence-theme' ),
			'700'       => esc_html__( 'Bold 700', 'gi-essence-theme' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'gi-essence-theme' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'gi-essence-theme' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'gi-essence-theme' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'gi-essence-theme' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'gi-essence-theme' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'gi-essence-theme' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'gi-essence-theme' ),
		);
	}
