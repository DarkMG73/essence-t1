...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'essencetheme' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'essencetheme' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'essencetheme' ),
			'200'       => esc_html__( 'Light 200', 'essencetheme' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'essencetheme' ),
			'300'       => esc_html__( 'Book 300', 'essencetheme' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'essencetheme' ),
			'400'       => esc_html__( 'Normal 400', 'essencetheme' ),
			'regular'   => esc_html__( 'Normal 400', 'essencetheme' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'essencetheme' ),
			'500'       => esc_html__( 'Medium 500', 'essencetheme' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'essencetheme' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'essencetheme' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'essencetheme' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'essencetheme' ),
			'700'       => esc_html__( 'Bold 700', 'essencetheme' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'essencetheme' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'essencetheme' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'essencetheme' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'essencetheme' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'essencetheme' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'essencetheme' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'essencetheme' ),
		);
	}
