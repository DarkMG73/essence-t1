	...
	<figure class="entry-attachment">
       ...
       <?php endif; ?>
		...
		while ( have_posts() ) :
			...
			the_post_navigation(
				array(
					'prev_text' => '<span class="nav-subtitle">' . esc_html__( 'Previous:', 'gi-essence-theme' ) . '</span> <span class="nav-title">%title</span>',
					'next_text' => '<span class="nav-subtitle">' . esc_html__( 'Next:', 'gi-essence-theme' ) . '</span> <span class="nav-title">%title</span>',
				)
			);
